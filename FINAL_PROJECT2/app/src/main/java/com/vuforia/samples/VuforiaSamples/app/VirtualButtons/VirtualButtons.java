...
public class VirtualButtons extends Activity implements
    ...
    final public static int CMD_BUTTON_LEGO = 6;
    ...
    private static final int BUTTON_6 = 32; /* 10000 */
    public String virtualButtons[] = {"red_teapot", "blue_teapot", "yellow_cube", "custom_object", "rotation", "lego_button"};
    ...
    // We want to load speciic textures from the APK, which we will later use
    // for rendering.
    private void loadTextures() {
        ...
        mTextures.add(Texture.loadTextureFromApk("VirtualButtons/TextureCubeYellow.png", getAssets()));
        mTextures.add(Texture.loadTextureFromApk("VirtualButtons/lego_diffuse.png", getAssets()));
        mTextures.add(Texture.loadTextureFromApk("VirtualButtons/Tomato_texture.png", getAssets()));
        mTextures.add(Texture.loadTextureFromApk("VirtualButtons/Banana.jpg", getAssets()));
        mTextures.add(Texture.loadTextureFromApk("VirtualButtons/pear_diffuse.jpg", getAssets()));
        mTextures.add(Texture.loadTextureFromApk("VirtualButtons/Albedo.png", getAssets()));
        mTextures.add(Texture.loadTextureFromApk("VirtualButtons/Army_boot_texture.png", getAssets()));
        mTextures.add(Texture.loadTextureFromApk("VirtualButtons/heart_lp.png", getAssets()));
        ...
        if (updateBtns) {
            ...
            if ((buttonMask & BUTTON_1) != 0) {
                ...
                toggleVirtualButton(imageTarget, virtualButtons[0],
                        -0.0695f, -0.0571f, -0.0593f, -0.0457f);
    ...
    private void setSampleAppMenuSettings() {
        ...
        group.addSelectionItem(getString(R.string.menu_button_rotation),
                CMD_BUTTON_ROT, true);
        group.addSelectionItem(getString(R.string.menu_button_lego),
                CMD_BUTTON_LEGO, true);
